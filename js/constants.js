...
export const VIS_ID = 'visContainer';
export const VIS_HEIGHT = '750px'; // height of visualization in pixels
export const VIS_WIDTH_WORLDMAP = '80%';
export const VIS_WIDTH_FORCE = '100%';

export const SELECTED_COUNTRY = "USA";

export const DEFAULT_FILL = '#d3d3d3'; // default country color (no data)
export const SELECTED_FILL = '#228B22'; // selected country color
...
export const NUM_INCREMENTS = 7;
export const DIGITS_ROUNDED = 2;

// visualization modes
export const ENABLED_MODES = [worldMap, force];
